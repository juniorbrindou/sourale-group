<div>
    <div>
        ...
        <tr class="{{($entrer->isValidated)?'table-secondary':''}}">
            ...
            <td>
                <a href="{{ route('approvisionnement.show', $entrer->id) }}" class="btn btn-warning btn-md mr-1">
                    <i class="fa fa-eye"></i>
                    </button>
                </a>
                <a href="{{ route('approvisionnement.edit', $entrer->id) }}" title="Modiffier"
