			...
			<div class="col-md-12 ">
				...
				<div class="card card-primary box-perso">
					<div class="card-header">
						<h3 class="card-title">modification du Tarif</h3>
					</div>
					<!-- /.card-header -->
					<!-- form start -->
								...
								<div class="col-md-4 col-xs-12">
									...
									<div class="form-group">
										...
										<input type="number" required
											...
											value="{{ $tarif->prix }}" name="prix" id="prix"
								...
								<div class="col-md-4 ">
									<div class="form-group">
										...
										<select required class="form-control select2" name="type_article_id"
											...
											<option value="{{$tarif->type_article_id}}" selected>
												{{$tarif->type_article->libelle}}
											</option>
								...
								<div class="col-md-4 ">
									<div class="form-group">
										...
										<select required class="form-control select2" style="width: 100%;"
											...
											<option value="{{$tarif->categorie_article_id}}" selected>
												{{$tarif->categorie_article->libelle}}
											</option>
