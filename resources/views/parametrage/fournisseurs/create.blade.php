							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" class="form-control" value="{{ old('contact') }}" data-inputmask='"mask": "(999) 99-99-99-99-99"' name="contact" data-mask>
										</div>
										<!-- /.input group -->
									</div>
								</div>
						...
						<div class="card-footer">
							<div class="row">
								<div class="col-md-6 col-sm-6">
									<a href="{{ route('fournisseurs.index') }}" class="btn btn-warning btn-block text-light mb-2">Retour</a>
								</div>
								<div class="col-md-6 col-sm-6">
