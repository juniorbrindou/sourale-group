			...
			<div class="col-md-12 ">
				...
				<div class="card card-primary box-perso">
					<div class="card-header">
						<h3 class="card-title">Modification Catégorie : <b>{{ $package->libelle }}</b> </h3>
					</div>
					<!-- /.card-header -->
					<!-- form start -->
								...
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control @error('libelle') is-invalid @enderror"
											value="{{ $package->libelle }}" name="libelle" id="libelle">
									</div>
									@error('libelle')
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<textarea class="form-control @error('description') is-invalid @enderror"
											name="description" rows="3" placeholder="Ecrivez ici...">{{ $package->description }}</textarea>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card-footer">
							<div class="row">
								<div class="col-md-6 col-sm-6 mb-2">
									<a href="{{ route('packages.index') }}" class="btn btn-warning btn-block text-light">Retour</a>
								</div>
