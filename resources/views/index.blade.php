			...
			<div class="col-md-8">
				...
				<div class="card">
					...
					<div class="card-footer clearfix">
						<a href="javascript:void(0)" class="btn btn-sm btn-info float-left">Passer une nouvelle commande</a>
						<a href="javascript:void(0)" class="btn btn-sm btn-secondary float-right">Voir toutes les commandes</a>
					</div>
					<!-- /.card-footer -->
				</div>
				<!-- /.card -->
