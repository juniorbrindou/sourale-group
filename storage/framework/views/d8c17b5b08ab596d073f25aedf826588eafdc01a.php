...
} elseif ($_instance->childHasBeenRendered('rxCPp3M')) {
    $componentId = $_instance->getRenderedChildComponentId('rxCPp3M');
    $componentTag = $_instance->getRenderedChildComponentTagName('rxCPp3M');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rxCPp3M');
} else {
    $response = \Livewire\Livewire::mount('location.index', []);
    $html = $response->html();
    $_instance->logRenderedChild('rxCPp3M', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
