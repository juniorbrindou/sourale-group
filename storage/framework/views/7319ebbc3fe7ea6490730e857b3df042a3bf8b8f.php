			...
			<div class="col-md-12 ">
				...
				<div class="card card-primary box-perso">
					<div class="card-header">
						<h3 class="card-title">Modification Client : <b><?php echo e($client->nom); ?> </b> </h3>
					</div>
					<!-- /.card-header -->
					<!-- form start -->
...
unset($__errorArgs, $__bag); ?>"
											value="<?php echo e($client->nom); ?>" name="nom" autofocus id="nom">
									</div>
									<?php $__errorArgs = ['nom'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" name="contact1" value="<?php echo e(old('contact1')); ?>" data-inputmask='"mask": "(999) 99-99-99-99-99"' name="contact1" data-mask>
									</div>
									<!-- /.input group -->
								</div>
							</div>
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" name="contact2" value="<?php echo e(old('contact2')); ?>" data-inputmask='"mask": "(999) 99-99-99-99-99"' name="contact2" data-mask>
									</div>
									<!-- /.input group -->
								</div>
							</div>
...
unset($__errorArgs, $__bag); ?>"
										name="adresse" rows="3" placeholder="Ecrivez ici..."><?php echo e($client->adresse); ?></textarea>
								</div>
							</div>
						</div>
						...
						<div class="card-footer">
							<div class="row">
								<div class="col-md-6 col-sm-6 mb-2">
									<a href="<?php echo e(route('clients.index')); ?>" class="btn btn-warning btn-block text-light">Retour</a>
								</div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Brindou\OneDrive\Documents\GitHub\sourale-group\resources\views/parametrage/clients/edit.blade.php ENDPATH**/ ?>