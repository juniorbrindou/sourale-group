...
} elseif ($_instance->childHasBeenRendered('e3e915C')) {
    $componentId = $_instance->getRenderedChildComponentId('e3e915C');
    $componentTag = $_instance->getRenderedChildComponentTagName('e3e915C');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('e3e915C');
} else {
    $response = \Livewire\Livewire::mount('location.index', []);
    $html = $response->html();
    $_instance->logRenderedChild('e3e915C', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SouraleApp\last-project\resources\views/location/index.blade.php ENDPATH**/ ?>