...
<div id="container">
    <div class="banner">
        <img src="<?php echo e(asset('img/facture.png')); ?>" alt="banniere" class="img-banner">
    </div>
    <div id="header">
        <div id="reference">
...
<?php /**PATH C:\SouraleApp\last-project\resources\views/facture/invoice.blade.php ENDPATH**/ ?>