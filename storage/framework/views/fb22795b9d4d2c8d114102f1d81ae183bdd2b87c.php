...
} elseif ($_instance->childHasBeenRendered('RSFaxDA')) {
    $componentId = $_instance->getRenderedChildComponentId('RSFaxDA');
    $componentTag = $_instance->getRenderedChildComponentTagName('RSFaxDA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('RSFaxDA');
} else {
    $response = \Livewire\Livewire::mount('location.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('RSFaxDA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sourale-group\resources\views/location/create.blade.php ENDPATH**/ ?>