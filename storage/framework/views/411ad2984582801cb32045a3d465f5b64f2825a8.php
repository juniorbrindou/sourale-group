...
} elseif ($_instance->childHasBeenRendered('NBGM7KW')) {
    $componentId = $_instance->getRenderedChildComponentId('NBGM7KW');
    $componentTag = $_instance->getRenderedChildComponentTagName('NBGM7KW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NBGM7KW');
} else {
    $response = \Livewire\Livewire::mount('location.terminee', ['evenement' => $evenement]);
    $html = $response->html();
    $_instance->logRenderedChild('NBGM7KW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SouraleApp\last-project\resources\views/location/terminee.blade.php ENDPATH**/ ?>