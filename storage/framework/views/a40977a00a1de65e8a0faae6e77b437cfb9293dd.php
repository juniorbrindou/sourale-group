...
} elseif ($_instance->childHasBeenRendered('dtzXIub')) {
    $componentId = $_instance->getRenderedChildComponentId('dtzXIub');
    $componentTag = $_instance->getRenderedChildComponentTagName('dtzXIub');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dtzXIub');
} else {
    $response = \Livewire\Livewire::mount('approvisionnement.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('dtzXIub', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SouraleApp\last-project\resources\views/entrers/create.blade.php ENDPATH**/ ?>