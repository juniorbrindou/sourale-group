			...
			<div class="col-md-12">
				...
				<div class="card card-primary box-perso">
					<div class="card-header">
						<h3 class="card-title">Nouveau type d'événements</h3>
					</div>
					<!-- /.card-header -->
					<!-- form start -->
					<form method="POST" action="<?php echo e(route('typeEvenements.store')); ?>">
						<?php echo csrf_field(); ?>
						<div class="card-body">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Brindou\OneDrive\Documents\GitHub\sourale-group\resources\views/parametrage/typeEvenements/create.blade.php ENDPATH**/ ?>