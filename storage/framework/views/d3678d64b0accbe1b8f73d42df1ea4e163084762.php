...
} elseif ($_instance->childHasBeenRendered('BHW7Cdv')) {
    $componentId = $_instance->getRenderedChildComponentId('BHW7Cdv');
    $componentTag = $_instance->getRenderedChildComponentTagName('BHW7Cdv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BHW7Cdv');
} else {
    $response = \Livewire\Livewire::mount('approvisionnement.index', []);
    $html = $response->html();
    $_instance->logRenderedChild('BHW7Cdv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
