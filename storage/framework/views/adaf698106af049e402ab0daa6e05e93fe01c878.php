...
} elseif ($_instance->childHasBeenRendered('9GsSc3b')) {
    $componentId = $_instance->getRenderedChildComponentId('9GsSc3b');
    $componentTag = $_instance->getRenderedChildComponentTagName('9GsSc3b');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9GsSc3b');
} else {
    $response = \Livewire\Livewire::mount('approvisionnement.index', []);
    $html = $response->html();
    $_instance->logRenderedChild('9GsSc3b', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sourale-group\resources\views/entrers/index.blade.php ENDPATH**/ ?>