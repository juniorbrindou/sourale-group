    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('approvisionnement.create', [])->html();
} elseif ($_instance->childHasBeenRendered('T9K3gBo')) {
    $componentId = $_instance->getRenderedChildComponentId('T9K3gBo');
    $componentTag = $_instance->getRenderedChildComponentTagName('T9K3gBo');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('T9K3gBo');
} else {
    $response = \Livewire\Livewire::mount('approvisionnement.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('T9K3gBo', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Brindou\OneDrive\Documents\GitHub\sourale-group\resources\views/entrers/create.blade.php ENDPATH**/ ?>