...
} elseif ($_instance->childHasBeenRendered('4FMDOYw')) {
    $componentId = $_instance->getRenderedChildComponentId('4FMDOYw');
    $componentTag = $_instance->getRenderedChildComponentTagName('4FMDOYw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4FMDOYw');
} else {
    $response = \Livewire\Livewire::mount('approvisionnement.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('4FMDOYw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
