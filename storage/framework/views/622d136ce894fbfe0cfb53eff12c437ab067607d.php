...
} elseif ($_instance->childHasBeenRendered('uYf38xZ')) {
    $componentId = $_instance->getRenderedChildComponentId('uYf38xZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('uYf38xZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('uYf38xZ');
} else {
    $response = \Livewire\Livewire::mount('approvisionnement.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('uYf38xZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sourale-group\resources\views/entrers/create.blade.php ENDPATH**/ ?>