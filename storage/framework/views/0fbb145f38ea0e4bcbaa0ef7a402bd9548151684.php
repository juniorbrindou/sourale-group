...
unset($__errorArgs, $__bag); ?>" name="motif"
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="card bg-light">
        <div class="card-header">
            <h3 class="card-title">Sortie de stock <?php echo e(date('Y-m-d')); ?> </h3>
        </div>
        <div class="card-body">
...
<?php /**PATH C:\Users\Brindou\OneDrive\Documents\GitHub\sourale-group\resources\views/livewire/destockage/create.blade.php ENDPATH**/ ?>