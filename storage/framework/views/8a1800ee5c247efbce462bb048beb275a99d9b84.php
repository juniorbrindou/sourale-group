		...
		<div class="row">
			...
			<div class="col-md-12 ">
				...
				<div class="card card-primary box-perso">
					...
					<!-- /.card-header -->
					<!-- form start -->
					<form method="POST" action="<?php echo e(route('typeEvenements.update', $typeEvenement->id)); ?>">
						<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
											value="<?php echo e($typeEvenement->libelle); ?>" name="libelle" id="libelle">
									</div>
...
unset($__errorArgs, $__bag); ?>"
											name="description" rows="3" placeholder="Ecrivez ici..."><?php echo e($typeEvenement->description); ?></textarea>
									</div>
								</div>
							</div>
						</div>
