...
} elseif ($_instance->childHasBeenRendered('lDcHNWn')) {
    $componentId = $_instance->getRenderedChildComponentId('lDcHNWn');
    $componentTag = $_instance->getRenderedChildComponentTagName('lDcHNWn');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lDcHNWn');
} else {
    $response = \Livewire\Livewire::mount('location.retour', ['evenement' => $evenement]);
    $html = $response->html();
    $_instance->logRenderedChild('lDcHNWn', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SouraleApp\last-project\resources\views/location/retour.blade.php ENDPATH**/ ?>