...
} elseif ($_instance->childHasBeenRendered('cUwc7KC')) {
    $componentId = $_instance->getRenderedChildComponentId('cUwc7KC');
    $componentTag = $_instance->getRenderedChildComponentTagName('cUwc7KC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cUwc7KC');
} else {
    $response = \Livewire\Livewire::mount('approvisionnement.index', []);
    $html = $response->html();
    $_instance->logRenderedChild('cUwc7KC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SouraleApp\last-project\resources\views/entrers/index.blade.php ENDPATH**/ ?>