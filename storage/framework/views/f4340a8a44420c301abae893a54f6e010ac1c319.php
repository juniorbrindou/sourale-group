    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-12">
                <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('location.retour', ['evenement' => $evenement])->html();
} elseif ($_instance->childHasBeenRendered('N4wdshe')) {
    $componentId = $_instance->getRenderedChildComponentId('N4wdshe');
    $componentTag = $_instance->getRenderedChildComponentTagName('N4wdshe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('N4wdshe');
} else {
    $response = \Livewire\Livewire::mount('location.retour', ['evenement' => $evenement]);
    $html = $response->html();
    $_instance->logRenderedChild('N4wdshe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Brindou\OneDrive\Documents\GitHub\sourale-group\resources\views/location/retour.blade.php ENDPATH**/ ?>