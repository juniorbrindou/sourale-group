...
} elseif ($_instance->childHasBeenRendered('6BuSqPq')) {
    $componentId = $_instance->getRenderedChildComponentId('6BuSqPq');
    $componentTag = $_instance->getRenderedChildComponentTagName('6BuSqPq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('6BuSqPq');
} else {
    $response = \Livewire\Livewire::mount('location.retour', ['evenement' => $evenement]);
    $html = $response->html();
    $_instance->logRenderedChild('6BuSqPq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
