...
} elseif ($_instance->childHasBeenRendered('j850nhx')) {
    $componentId = $_instance->getRenderedChildComponentId('j850nhx');
    $componentTag = $_instance->getRenderedChildComponentTagName('j850nhx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('j850nhx');
} else {
    $response = \Livewire\Livewire::mount('location.create', []);
    $html = $response->html();
    $_instance->logRenderedChild('j850nhx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\SouraleApp\last-project\resources\views/location/create.blade.php ENDPATH**/ ?>