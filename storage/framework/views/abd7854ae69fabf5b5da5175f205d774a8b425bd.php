...
} elseif ($_instance->childHasBeenRendered('dP1iSN5')) {
    $componentId = $_instance->getRenderedChildComponentId('dP1iSN5');
    $componentTag = $_instance->getRenderedChildComponentTagName('dP1iSN5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dP1iSN5');
} else {
    $response = \Livewire\Livewire::mount('location.terminee', ['evenement' => $evenement]);
    $html = $response->html();
    $_instance->logRenderedChild('dP1iSN5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sourale-group\resources\views/location/terminee.blade.php ENDPATH**/ ?>