                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Auteur : <?php echo e($entrer->user->nom); ?>

                                                <?php echo e($entrer->user->prenoms); ?></h3>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Sourale-group\resources\views/entrers/show.blade.php ENDPATH**/ ?>